## [Camel Interface Agent](https://github.com/Coral-Protocol/Coral-Camel-Interface-Agent)
...
- **AI model**: GPT-4.1-mini, GROQ-llama-3.3-70b
...
git clone https://github.com/Coral-Protocol/Coral-Camel-Interface-Agent.git

# Navigate to the project directory:
cd Coral-Camel-Interface-Agent
